...
const Personal = () => {
  return (
    <div>
      ...
      <nav className="navbar navbar-light bg-light" style={{ paddingLeft: '1rem', marginBottom: '2rem' }}>
        <div className="container-fluid px-0">
          <div className="d-flex justify-content-start">
            <Link className="nav-link me-4 fw-bold" to="/transactions">Transactions</Link>
            <Link className="nav-link me-4 fw-bold" to="/insurance">Insurance</Link>
            <Link className="nav-link me-4 fw-bold" to="/investments">Investments</Link>
            <Link className="nav-link me-4 fw-bold" to="/mortgages">Mortgages</Link>
          </div>
        </div>
      </nav>
            ...
            <div>
              ...
              <Link to="/learn-more">
                <button className="btn btn-light" style={{
                  ...
                  onMouseOver={(e) => e.currentTarget.style.backgroundColor = '#3d3a9b'} // Navy blue on hover
                  onMouseOut={(e) => e.currentTarget.style.backgroundColor = '#add8e6'}> {/* Light blue default */}
                  Learn More
                </button>
              </Link>
            </div>
      ...
      <div className="container-fluid px-0">
        <div className="row g-3 mb-4"> {/* Added gap using g-3 */}
          <div className="col-md-4 d-flex align-items-center justify-content-center" style={{ padding: '1rem' }}> {/* Added padding */}
      ...
      <div className="container-fluid px-0">
        <div className="row g-3 mb-4">
          ...
          <div className="col-md-4 d-flex align-items-center justify-content-center" style={{ padding: '2rem', backgroundColor: '#c4c2e1' }}>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              ...
              <ul className="list-unstyled">
                <li><Link to="#" className="text-light">Personal Banking</Link></li>
                <li><Link to="#" className="text-light">Bank Accounts</Link></li>
                <li><Link to="#" className="text-light">Credit Cards</Link></li>
                <li><Link to="#" className="text-light">Mortgages</Link></li>
              </ul>
            </div>
